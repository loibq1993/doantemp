...
<div id = "right-search">
	<h10>Hóa Học Lớp 11</h10>
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 1: Sự Điện Li</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 1: Sự điện li</li>
				<li>Bài 2: Axit, bazơ và muối</li>
				<li>Bài 3: Sự điện li của nước - pH và Chất chỉ thị axit-bazơ</li>
				<li>Bài 4: Phản ứng trao đổi ion trong dung dịch các chất điện li</li>
				<li>Bài 5: Luyện tập Axit, bazơ và muối và Phản ứng trao đổi ion trong dung dịch các chất điện li</li>
				<li>Bài 6: Bài thực hành 1 Tính axit-bazơ và Phản ứng trao đổi ion trong dung dịch các chất điện li</li>
			</ul>
		</div>
		<div id="detail">
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 2: Nitơ - Photpho</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 7: Nitơ</li>
				<li>Bài 8: Amoniac và muối amoni</li>
				<li>Bài 9: Axit nitric và muối nitrat</li>
				<li>Bài 10: Photpho</li>
				<li>Bài 11: Axit photphoric và muối photphat</li>
				<li>Bài 13: Luyện tập Tính chất của nitơ, photpho và các hợp chất của chúng</li>
				<li>Bài 14: Bài thực hành 2 Tính chất của một số hợp chất nitơ, photpho</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 3: Cacbon - Silic</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 15: Cacbon</li>
				<li>Bài 16: Hợp chất của cacbon</li>
				<li>Bài 17: Silic và hợp chất của silic</li>
				<li>Bài 18: Công nghiệp silicat</li>
				<li>Bài 19: Luyện tập Tính chất hóa học của cacbon, silic và các hợp chất của chúng</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 4: Đại Cương Về Hóa Học Hữu Cơ</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 20: Mở đầu về hóa học hữu cơ</li>
				<li>Bài 21: Công thức phân tử hợp chất hữu cơ</li>
				<li>Bài 22: Cấu trúc phân tử hợp chất hữu cơ</li>
				<li>Bài 23: Phản ứng hữu cơ</li>
				<li>Bài 24: Luyện tập Hợp chất hữu cơ, công thức phân tử và công thức cấu tạo</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 5: Hiđrocacbon No</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 25 Ankan</li>
				<li>Bài 26: Xicloankan</li>
				<li>Bài 27 Luyện tập Ankan và xicloankan</li>
				<li>Bài 28: Bài thực hành số 3 Phân tích định tính nguyên tố và Điều chế và tính chất của metan</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương 6: Hiđrocacbon Không No</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 29: Anken</li>
				<li>Bài 30 Ankađien</li>
				<li>Bài 31: Luyện tập Anken và ankađien</li>
				<li>Bài 32: Ankin</li>
				<li>Bài 33: Luyện tập Ankin</li>
				<li>Bài 34: Bài thực hành 4 Điều chế và tính chất của etilen và axetilen</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
		...
		<div id="baihoc">
			<div id="tieude1">
				<h4>Chương 8: Dẫn Xuất Halogen - Ancol - Phenol</h4>
			</div>
			<div id="noidung">
				<ul>
					<li>Bài 39: Dẫn xuất halogen của hiđrocacbon</li>
					<li>Bài 40: Ancol</li>
					<li>Bài 41 Phenol</li>
					<li>Bài 42 : Luyện tập Dẫn xuất halogen, ancol, phenol</li>
					<li>Bài 43: Bài thực hành 5 Tính chất của etanol, glixerol và phenol</li>
				</ul>
			</div>
			<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
		...
		<div id="baihoc">
			<div id="tieude1">
				<h4>Chương 9: Anđehit - Xeton - Axit cacboxylic</h4>
			</div>
			<div id="noidung">
				<ul>
					<li>Bài 44: Anđehit - Xeton</li>
					<li>Bài 45: Axit cacboxylic</li>
					<li>Bài 46 Luyện tập Anđehit - Xeton- Axit cacboxylic</li>
					<li>Bài 47: Bài thực hành 6 Tính chất của anđehit và axit cacboxylic</li>
				</ul>
			</div>
			<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
