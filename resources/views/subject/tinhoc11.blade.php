...
<div id = "right-search">
	<h10>Tin học Lớp 11</h10>
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương I: Một Số Khái Niệm Về Lập Trình Và Ngôn Ngữ Lập Trình</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 1: Khái niệm về lập trình và ngôn ngữ lập trình</li>
				<li>Bài 2: Các thành phần của ngôn ngữ lập trình</li>
	...
	<div id="baihoc">
		...
		<div id="noidung">
			<ul>
				<li>Bài 3: Cấu trúc chương trình</li>
				<li>Bài 4: Một số kiểu dữ liệu chuẩn
				<li>Bài 5: Khai báo biến</li>
				<li>Bài 6: Phép toán, biểu thức, câu lệnh gán</li>
				<li>Bài 7: Các thủ tục vào/ra đơn giản</li>
				<li>Bài 8: Soạn thảo, dịch, thực hiện và hiệu chỉnh chương trình</li>
				<li>Bài tập và thực hành 1</li>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương III: Cấu Trúc Rẽ Nhánh Và Lặp</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 9: Cấu trúc rẽ nhánh</li>
				<li>Bài 10: Cấu trúc lặp</li>
				<li>Bài tập và thực hành 2</li>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương IV: Kiểu Dữ Liệu Có Cấu Trúc</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 11: Kiểu mảng</li>
				<li>Bài tập và thực hành 3</li>
				<li>Bài tập và thực hành 4</li>
				<li>Bài 12: Kiểu xâu
				<li>Bài tập và thực hành 5</li>
				<li>Bài 13: Kiểu bản ghi</li>
				<li>Ôn tập chương 4: Kiểu dữ liệu có cấu trúc</li>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương V: Tệp Và Thao Tác Với Tệp</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 14: Kiểu dữ liệu tệp</li>
				<li>Bài 15: Thao tác với tệp</li>
				<li>Bài 16: Ví dụ làm việc với tệp</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
	...
	<div id="baihoc">
		<div id="tieude1">
			<h4>Chương VI: Chương Trình Con Và Lập Trình Có Cấu Trúc</h4>
		</div>
		<div id="noidung">
			<ul>
				<li>Bài 17: Chương trình con và phân loại</li>
				<li>Bài 18: Ví dụ về cách viết và sử dụng chương trình con</li>
				<li>Bài tập và thực hành 6</li>
				<li>Bài tập và thực hành 7</li>
				<li>Bài 19: Thư viện chương trình con chuẩn</li>
				<li>Bài tập và thực hành 8</li>
			</ul>
		</div>
		<div id="detail">
				<button type="button" class="btn btn-primary" style="border-radius: 5px">Xem chi tiết</button>
