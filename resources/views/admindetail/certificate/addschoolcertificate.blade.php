...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark bold uppercase"><i class="fas fa-graduation-cap" style="margin-right:10px "></i>TẠO GIẤY CHỨNG NHẬN TỐT NGHIỆP TẠM THỜI</span>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <form action="{{ url('/admin/addsct')}}" class="form-horizontal form-row-seperated" method="POST" id="export-data-form">
                {{ csrf_field() }}
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-bordered table-checkable" style="width: 100%">
                                <tr class="background">
                                    ...
                                    <th>Tạo giấy chứng nhận TN tạm thời</th>                       
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            @if($student->user_id == null) 
                                                <a class="label label-sm label-warning" href="{{ url('/admin/sctemp?stid='.$student->id) }}">Tạo giấy CNTN tạm thời</a>
                                            @else 
                                                 <span class="label label-danger">Đã tạo</span>
                                            @endif
