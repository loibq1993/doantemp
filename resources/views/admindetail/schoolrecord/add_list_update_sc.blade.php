    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase"><i class="fas fa-clipboard-check" style="margin-right: 10px"></i>NHẬP HỌC BẠ</span>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <form action="{{ url('/admin/list_update_student_report')}}" class="form-horizontal form-row-seperated" method="POST" id="export-data-form">
                {{ csrf_field() }}
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-bordered table-checkable" style="width: 100%">
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <a class="label label-sm label-warning" href="{{ url('/admin/updatesr?cid='.$student->class_id.'&usid='.$student->id)}}">Nhập học bạ</a>
                                        </td>
                                        <td>
                                             <a class="label label-sm label-warning" href="{{ url('/admin/watchsc?cid='.$student->class_id.'&usid='.$student->id)}}">Xem chi tiết</a>
                                            {{-- <a class="label label-sm label-warning" href="{{ url('/admin/updatesr?cid='.$student->class_id.'&usid='.$student->id)}}">Nhập học bạ</a> --}}
                                        </td>
                                        {{-- <td>
                                            <a class="label label-sm label-warning" href="{{ url('/admin/watchsc?cid='.$student->class_id.'&usid='.$student->id)}}">Xem chi tiết</a>
