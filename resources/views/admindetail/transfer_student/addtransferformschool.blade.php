...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-dark bold uppercase"><i class=" fas fa-map-marked-alt" style="margin-right: 10px"></i>LẬP PHIẾU ĐIỀU CHUYỂN TRƯỜNG HỌC SINH</span>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <form action="{{ url('/admin/transfer_student_school')}}" class="form-horizontal form-row-seperated" method="POST" id="export-data-form">
                {{ csrf_field() }}
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-bordered table-checkable" style="width: 100%">
                                <tr class="background">
                                    ...
                                    <th>Tạo phiếu điều chuyển trường</th>                       
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td><a class="label label-sm label-warning" href="{{ url('/admin/formdctrtuong?stid='.$student->id) }}">Lập phiếu điều chuyển trường</a></td>                              
                                </tr>
                                @endforeach
                            </table>
                    </div>
