    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-dark bold uppercase"><i class="far fa-hand-point-right" style="margin-right: 10px"></i>LẬP KHEN THƯỞNG - KỶ LUẬT HỌC SINH</span>
            </div>
        </div>
        <div class="portlet-body form">
            ...
            <form action="{{ url('/admin/list_add_bodis')}}" class="form-horizontal form-row-seperated" method="POST" id="export-data-form">
                {{ csrf_field() }}
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover table-bordered table-checkable" style="width: 100%">
                                <tr class="background">
                                    ...
                                    <th style="width: auto">Tạo khen thưởng - kỷ luật</th>                       
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td>
                                            <a class="label label-sm label-warning" href="{{ url('/admin/formktkl?stid='.$student->id) }}">Tạo khen thưởng học sinh</a>
                                        </td>                              
                                </tr>
                                @endforeach
                            </table>
